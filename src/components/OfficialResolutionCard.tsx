...
import { X, FileText, Check, Copy, Printer } from "lucide-react";
...
export const OfficialResolutionCard: React.FC<OfficialResolutionCardProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-2 sm:p-4 backdrop-blur-md animate-fadeIn overflow-y-auto">
